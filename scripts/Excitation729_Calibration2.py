...
class Excitation729_Calibration2(pulse_sequence):
    ...
    show_params= [
                  'Excitation729Cal2.line_selection',
                  'Excitation729Cal2.amplitude729',
                  'Excitation729Cal2.duration729',
                  'Excitation729Cal2.sideband_selection',
                  'Excitation729Cal2.channel729',
                  'Excitation729Cal2.stark_shift_729',
                  'Excitation729Cal2.sideband_cooling_enable',
                  'Excitation729Cal2.rotation_enable',
                  'Excitation729Cal2.empty_sequence_duration',
                  'Excitation729Cal2.readout_mode',
                  'Excitation729Cal2.rf_modulation_enable',
    ...
    def sequence(self):
      ...
      e729c = self.parameters.Excitation729Cal2
    ...
    def run_initial(cls,cxn, parameters_dict):
      e729c = parameters_dict.Excitation729Cal2
    ...
    def run_finally(cls,cxn, parameters_dict, data, x):
        if parameters_dict.Excitation729Cal2.rotation_enable:
