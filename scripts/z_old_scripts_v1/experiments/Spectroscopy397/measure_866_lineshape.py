...
class measure_866_lineshape(experiment):
    
    name = 'measure_866_lineshape'
    required_parameters = [
                           ...
                           ('Spectroscopy_397','frequency_scan_866'),
    ...
    def initialize(self, cxn, context, ident):
        ...
        self.measure_866_lineshape_save_context = cxn.context()
    ...
    def setup_sequence_parameters(self):       
        ...
        minim,maxim,steps = spec.frequency_scan_866
    ...
    def do_get_excitation(self, cxn, context, freq):
        self.parameters['Spectroscopy_397.frequency_866'] = freq # WithUnit(80.0,'MHz') + (freq/2.0)
...
if __name__ == '__main__':
    ...
    exprt = measure_866_lineshape(cxn = cxn)
