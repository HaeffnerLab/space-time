...
class calibrate_397_power(experiment):
    
    name = 'calibrate_397_power'
    required_parameters = [
    ...
    def initialize(self, cxn, context, ident):
        ...
        self.calibration_397_power_save_context = cxn.context()
    ...
    def do_get_excitation(self, cxn, context, power):
        self.parameters['Spectroscopy_397.power_397'] = power
...
if __name__ == '__main__':
    ...
    exprt = calibrate_397_power(cxn = cxn)
