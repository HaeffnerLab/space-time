...
class excitation_ramsey_with_eit(base_excitation):
    from space_time.scripts.PulseSequences.ramsey_with_eit import ramsey_with_eit
    name = 'ExcitationRamseyWithEit'
    pulse_sequence = ramsey_with_eit

class ramsey_with_eit(experiment):
    ...
    def all_required_parameters(cls):
        ...
        parameters = parameters.union(set(excitation_ramsey_with_eit.all_required_parameters()))
    ...
    def initialize(self, cxn, context, ident):
        self.ident = ident
        self.excite = self.make_experiment(excitation_ramsey_with_eit)
    ...
    def setup_data_vault(self):
        ...
        ds = self.dv.new('Ramsey With EIT {}'.format(datasetNameAppend),[('Excitation', 'us')], dependants , context = self.data_save_context)
