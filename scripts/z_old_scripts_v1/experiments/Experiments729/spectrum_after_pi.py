...
from excitations import excitation_729_after_pi
...
class spectrum_after_pi(experiment):
    
    name = 'Spectrum729_after_pi'
    ...
    def all_required_parameters(cls):
        ...
        parameters = parameters.union(set(excitation_729_after_pi.all_required_parameters()))
        ...
        parameters.remove(('PiRotation','pi_rotation_frequency'))
        return parameters
    
    def initialize(self, cxn, context, ident, use_camera_override=None):
        self.ident = ident
        self.excite = self.make_experiment(excitation_729_after_pi)
    ...
    def load_frequency(self):
        ...
        self.parameters['PiRotation.pi_rotation_frequency'] = frequency
...
if __name__ == '__main__':
    ...
    exprt = spectrum_after_pi(cxn = cxn)
