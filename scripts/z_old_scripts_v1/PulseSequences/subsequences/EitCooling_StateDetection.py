...
class eit_cooling_statedetection(pulse_sequence):
    ...
    def sequence(self):
        ...
        linear_frequency = linear_397_freq_offset + sigma_frequency - eit.eit_cooling_zeeman_splitting/2.0 #extra factor of two because AO shifts twice
        ...
        self.addTTL('ReadoutCount', self.start, eit.eit_cooling_duration)
