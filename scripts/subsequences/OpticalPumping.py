...
class OpticalPumping(pulse_sequence):
    ...
    def sequence(self):
        ...
        if op.optical_pumping_type == 'continuous':
            ...
            self.addDDS(op.channel_729, self.start, opc.optical_pumping_continuous_duration, freq_729, op.optical_pumping_amplitude_729)
            ...
            for start in cycles_start:
                ...
                self.addDDS(op.channel_729, start, opp.optical_pumping_pulsed_duration_729 , freq_729 , ampl729)
