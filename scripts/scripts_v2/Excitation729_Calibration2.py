...
class Excitation729_Calibration2(pulse_sequence):
    ...
    show_params= [
                  'Excitation_729_Cal2.line_selection',
                  'Excitation_729_Cal2.amplitude729',
                  'Excitation_729_Cal2.duration729',
                  'Excitation_729_Cal2.sideband_selection',
                  'Excitation_729_Cal2.channel729',
                  'Excitation_729_Cal2.stark_shift_729',
                  'Excitation_729_Cal2.sideband_cooling_enable',
                  'Excitation_729_Cal2.rotation_enable',
                  'Excitation_729_Cal2.empty_sequence_duration',
    ...
    def sequence(self):
      ...
      e729c = self.parameters.Excitation_729_Cal2
    ...
    def run_initial(cls,cxn, parameters_dict):
      e729c = parameters_dict.Excitation_729_Cal2
    ...
    def run_finally(cls,cxn, parameters_dict, data, x):
        if parameters_dict.Excitation_729_Cal2.rotation_enable:
