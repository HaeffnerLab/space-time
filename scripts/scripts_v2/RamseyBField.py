...
class Ramsey(pulse_sequence):
    ...
    def sequence(self):
        ...
        ttl_dur = WithUnit(50, 'us')
        self.addTTL('awg_off',self.start,ttl_dur)
    ...
    def run_initial(cls,cxn, parameters_dict):
      ...
      if bf.bfield_enable:
        ...
        phase = bf.phase
        on_time = r.ramsey_time
        end_hold = bf.end_hold
        voltage_pp = bf.voltage_pp
        frequency = bf.frequency
        
        awg_bfield.program_b_field(phase['deg'],start_hold['ms'],on_time['ms'],end_hold['ms'],voltage_pp['V'],frequency['kHz'])
