...
class optical_pumping_continuous(pulse_sequence):
    ...
    def sequence(self):
        ...
        self.addDDS('729local', self.start, opc.optical_pumping_continuous_duration, opc.optical_pumping_continuous_frequency_729, opc.optical_pumping_continuous_amplitude_729)
        ...
        if aux.aux_op_enable:
            self.addDDS('729local', self.start, opc.optical_pumping_continuous_duration, aux.aux_optical_frequency_729, aux.aux_optical_pumping_amplitude_729)
