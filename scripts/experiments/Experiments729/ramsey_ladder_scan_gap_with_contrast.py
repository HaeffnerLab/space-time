...
from space_time.scripts.experiments.Experiments729.ramsey_ladder_scanphase_rotating import ramsey_ladder_scanphase_rotating
...
class ramsey_ladder_scan_gap_with_contrast(experiment):

    name = 'RamseyLadder_ScanGap_with_contrast'
    ...
    def all_required_parameters(cls):
        ...
        parameters = parameters.union(set(ramsey_ladder_scanphase_rotating.all_required_parameters()))
    ...
    def initialize(self, cxn, context, ident):
        ...
        self.scan_phase = self.make_experiment(ramsey_ladder_scanphase_rotating)
...
if __name__ == '__main__':
    ...
    exprt = ramsey_ladder_scan_gap_with_contrast(cxn = cxn)
