...
class SPACETIME_GUI(QtGui.QMainWindow):
    ...
    def create_layout(self, cxn):
        ...
        #laser_lock = self.makeLaserLockWidget(reactor, cxn)
        ...
        #self.tabWidget.addTab(laser_lock, 'Laserlock Status')
...
#        return widget
    ...
    def makeLaserRoomWidget(self, reactor, cxn):
        ...
        from common.clients.multiplexer.MULTIPLEXER_CONTROL_2 import multiplexerWidget # @@@ 
        gridLayout = QtGui.QGridLayout()
        ...
        return widget
    '''
    def makeLaserLockWidget(self, reactor, cxn):
        widget = QtGui.QWidget()
 
        from common.clients.laserlock.LASERLOCK_CONTROL import laserlockWidget

        gridLayout = QtGui.QGridLayout()

        gridLayout.addWidget(laserlockWidget(reactor),             0,0)
